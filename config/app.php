...
return [
     ...
     */
    'Security' => [
        'salt' => '2ff86493786641eb999335386fee6caf7091f4d30e7837a14c4a446ad20689ac',
    ],
    ...
    'Error' => [
        ...
        'skipLog' => ['Cake\Routing\Exception\MissingControllerException', 'Cake\Routing\Exception\MissingRouteException'],
        'log' => true,
        'trace' => true,
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'persistent' => false,
            'host' => $config["mysql"]["default"]["hostname"],
            /**
            ...
            'username' => $config["mysql"]["default"]["username"],
            'password' => $config["mysql"]["default"]["password"],
            'database' => $config["mysql"]["default"]["database"],
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'cacheMetadata' => true,
        ...
        'test' => [
            ...
            'driver' => 'Cake\Database\Driver\Mysql',
            'persistent' => false,
            'host' => $config["mysql"]["test"]["hostname"],
            //'port' => 'nonstandard_port_number',
